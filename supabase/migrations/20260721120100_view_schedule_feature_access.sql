-- STORY-6.3 — viewSchedule player Basic+ in has_feature_access.
-- Also syncs createSession for team_manager (STORY-6.1) into the CASE so the
-- SQL map matches packages/domain FEATURE_TIER_REQUIREMENTS.
