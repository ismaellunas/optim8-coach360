...
/* ── Access Control — centralized RBAC policy layer (STORY-5.1 / 5.2) ── */
function canAccess(user, feature) {
  if (!user) return false;
  return checkFeatureAccess({ role: user.role, tier: user.tier, feature }).allowed;
}

function accessLevel(user, feature) {
  if (!user) return "none";
  return featureAccessLevel(user.role, user.tier, feature);
}
